...
public class UpdatePatientFrame extends javax.swing.JFrame {
    ...
    public UpdatePatientFrame() {
        ...
        initComponents();loadDoctorId();loadPatientsId();
    }
    private int refs;
    private String opd;
    ...
    private void setPatientsDetais(String pid)
    {
        ...
        try{
              ...
              jcDocId.setSelectedItem(p.getDoctor_id());
    ...
    private boolean validateInput(){
        ...
        p_id=jcbPId.getSelectedItem().toString();
        opd=txtOpd.getText();
    ...
    public void updatePatientDetails (){
        if(validateInput()==true){
               ...
               // System.out.println(pp);
                try{
                    //System.out.println("jiiijij");
                    boolean result=PatientDao.updatePatient(pp);
                    
                   // System.out.println("result for inserting in db"+result);
                    if(result){
                        
                            JOptionPane.showMessageDialog(null," SUCESS","Patient Updated successfully",JOptionPane.INFORMATION_MESSAGE);
